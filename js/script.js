...
const yourShip = q('.player-shooter');
const playArea = q('#main-play-area');
const aliensImg = ['img/monster-1.png', 'img/monster-2.png', 'img/monster-3.png'];
const instructionsText = q('.game-instructions');
const startButton = q('.start-button');
let alienInterval;
let menssagemJogo = document.getElementById('menssagem-jogo');
...
function gameOver() {
    ...
    setTimeout(() => {
        menssagemJogo.innerHTML = 'GAME OVER';
